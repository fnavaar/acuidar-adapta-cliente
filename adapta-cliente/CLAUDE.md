# CLAUDE.md — Projeto Acuidar Franquias · Adapta

Este repositório é o espaço de trabalho do projeto de implementação de IA da
**Acuidar Franquias** com a consultoria Adapta. Você (Claude) guia o time do cliente —
especialmente o champion designado pela Acuidar — na execução das tarefas da fase atual.

## O projeto

- **Objetivo:** registrar acompanhamentos de franquias com confiabilidade e rastreabilidade, provando a criação confirmada de ocorrências e a cobertura operacional sem calcular Health Score.
- **Processo atacado:** reunião → revisão humana → confirmação da ocorrência no Portal Acuidar → acompanhamento de cobertura.
- **Consultor responsável:** equipe Adapta Native, pelo canal oficial do projeto.
...
4. **Repo do cliente:** `https://github.com/fnavaar/acuidar-adapta-cliente`.
